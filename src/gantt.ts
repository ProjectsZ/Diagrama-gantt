...
class GanttChart {
    ...
    constructor(containerId: string, data: ProyectoData) {
        ...
        this.createTooltip();
        this.setupControls();
        // Inicializar actividades expandidas por defecto
    ...
    private render(): void {
        ...
        // Dibujar conexiones después de renderizar las filas
        setTimeout(() => {
    ...
    private drawConnections(): void {
        ...
        this.flatActivities.forEach((current) => {
    ...
    private createActivityRow(actividad: Actividad, index: number): HTMLElement {
        ...
        if (hasSubactivities) {
            ...
            expandIcon.addEventListener('click', (e) => {
                e.stopPropagation();
                e.preventDefault();
                console.log('Expand icon clicked for activity:', actividad.id);
    ...
    private createBar(container: HTMLElement, actividad: Actividad, rowIndex: number): void {
        ...
        if (actividad.tipo === 'actividad') {
            ...
            // Container for diamond and label
